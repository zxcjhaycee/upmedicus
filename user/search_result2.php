...
<div class="container">
	...
	<?php
		$inc=4;
		$query=mysqli_query($conn,"select * from tbl_supply where Description like '%$name%'");
			...
			?>
				...
				<div>
					...
					<div style="margin-left:17px; margin-right:17px;">
						<button type="button" class="btn btn-primary btn-sm addcart" value="<?php echo $row['ID']; ?>"><i class="fa fa-shopping-cart fa-fw"></i> Add to Cart</button> <span class="pull-right"><strong><?php echo ₱number_format($row['product_price'],2); ?></strong></span> 
					</div>
				</div>
				</div>
			<?php
