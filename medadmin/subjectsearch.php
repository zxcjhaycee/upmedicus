...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#prev').on('click', function(){
			...
			pageprev -= 1;
			window.location = "subjectsearch.php?keyword=<?php echo $keyword ?>&total=<?php echo $total; ?>&fetch_detailed="+pageprev
				});
	}
	if(pagenext == <?php echo $total ?>){
		...
		$('#next').on('click', function(){
			...
			$(this).attr('disabled', false);
			pagenext2++
			window.location = "subjectsearch.php?keyword=<?php echo $keyword ?>&total=<?php echo $total; ?>&fetch_detailed="+pagenext2
		});
	}
	$('#firstpage').on('click', function(){
		var firstpage = 1;
			window.location = "subjectsearch.php?keyword=<?php echo $keyword ?>&total=<?php echo $total; ?>&fetch_detailed="+firstpage
	});
		$('#lastpage').on('click', function(){
		var lastpage = <?php echo $total ?>;
			window.location = "subjectsearch.php?keyword=<?php echo $keyword ?>&total=<?php echo $total; ?>&fetch_detailed="+lastpage
	});
