...
$(document).ready(function(){
	...
	$(document).on('click', '.concart', function(){
        ...
        $.amaran({
                ...
                color:'#fff',
                icon:'fa fa-warning',
                info:'The remaining stock is:'+qtystock,
                message: 'You cannot place an order beyond the stock limit'
                ...
                icon:'fa fa-check',
                info:'',
                message: 'The item is added to your cart'
	...
	$(document).on('click', '.remove_product', function(){
		...
		$.amaran({
                ...
                icon:'fa fa-check',
                info:'',
                message: 'The product is remove from your cart'
	...
	$(document).on('click', '.minus_qty', function(){
		...
		$.ajax({
			...
			success:function(data){
                ...
                icon:'fa fa-check',
                info:'',
                message: 'The product is removed from your cart'
	...
	$.amaran({
                ...
                icon:'fa fa-times',
                info:'',
                message: 'The number of quantity is exceeds the limit'
